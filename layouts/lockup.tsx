                ...
                <div className="relative z-30 p-5 text-2xl text-white font-open-sans text-center">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="max-w-xs mx-auto mb-5 md:mb-0">
                            <Image src={PFP} className={`rounded-full transition-opacity duration-500 ${loading > 0 ? 'opacity-100' : 'opacity-0'}`} onLoadingComplete={() => setLoading(loading + 1)} alt="Profile Picture"/>
                        </div>
